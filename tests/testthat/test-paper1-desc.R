test_that("paper1 descr builds", {
  ...
  expect_true(file.exists(
    file.path(dr, "descriptives_files/figure-html/data-1.png")
  ))
  expect_true(file.exists(
    file.path(
      dr,
  ...
  expect_true(file.exists(
    file.path(
      dr,
      "descriptives_files/figure-html/unnamed-chunk-20-1.png"
    )
  ))
  expect_true(file.exists(
    file.path(
      dr,
      "descriptives_files/figure-html/unnamed-chunk-37-1.png"
    )
  ))
